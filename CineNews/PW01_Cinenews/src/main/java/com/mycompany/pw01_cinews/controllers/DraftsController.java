 ...
 */
@WebServlet(name = "Drafts", urlPatterns = {"/Drafts"})
public class DraftsController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DraftsController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
