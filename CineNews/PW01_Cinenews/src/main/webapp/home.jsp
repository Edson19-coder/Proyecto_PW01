...
<%}%>
    ...
    <div class="container text-center">
        ...
        %>
        <form action="./ViewNew" method="GET">
            <input name="Noticia" type="text" value="<%= n.getIdnews() %>" style="display: none;" />
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text"><small class="text-muted"><%= n.getNewDate() %></small></p>  
                                <div style="text-align: right;"><input type="submit" value="Ver" style="margin-bottom: -10px; margin-rigth: 10px;"/></div>
                            </div>
                        </div>
                    </div>
                </div>
